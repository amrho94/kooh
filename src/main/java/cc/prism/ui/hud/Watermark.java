...
/**
 * Top-left watermark: "Prism Client  v1.0  â€¢  username"
...
public class Watermark extends HudElement {
    ...
    public void render(GuiGraphicsExtractor ctx, float delta) {
        ...
        // Background pill
        int totalWidth = RenderUtil.textWidth(clientText + versionText + "  â€¢  " + userText) + 10;
        ...
        // Render text parts
        RenderUtil.drawText(ctx, "Â§fÂ§l" + clientText, x + 2, y + 3, 0xFFFFFFFF, false);
        int afterClient = x + 2 + RenderUtil.textWidth("Â§fÂ§l" + clientText);

        RenderUtil.drawText(ctx, "Â§r" + versionText, afterClient, y + 3, accent, false);
        ...
        int afterSep = afterVersion + RenderUtil.textWidth("  â€¢  ");

        RenderUtil.drawText(ctx, "Â§f" + userText, afterSep, y + 3, 0xFFEEEEEE, false);
    }
}
